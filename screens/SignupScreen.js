...
import { auth,db, firestore,createUserWithEmailAndPassword,updateProfile } from '../firebase/index';
...
if (authUser) {
    await updateProfile(authUser, {
        displayName:name  // Replace with actual name from a form or similar
    });
}
