...
import { getAuth, createUserWithEmailAndPassword, signInWithRedirect, getRedirectResult,updateProfile } from 'firebase/auth';
...
export { auth, db, createUserWithEmailAndPassword, signInWithRedirect, getRedirectResult, provider,updateProfile };
